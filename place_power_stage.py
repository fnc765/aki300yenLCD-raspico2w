...
PLACEMENT = {
    "J2": (3.4, 28.0, 90), "J3": (2.25, 38.75, 180),
    "U3": (13.95, 26.75, 0), "L1": (17.25, 15.25, 180),
    "C6": (15.0, 40.0, 270), "R7": (24.5, 22.75, 180),
    "R8": (25.4, 30.8, 270), "D4": (8.5, 18.25, 270),
    "C8": (3.75, 18.5, 270), "C7": (12.25, 31.5, 270),
    "R9": (21.25, 32.5, 180), "R10": (21.0, 36.0, 270),
    "C9": (7.75, 35.5, 270), "D6": (8.75, 41.25, 180),
    "D7": (15.75, 31.25, 270), "C11": (21.0, 27.0, 270),
    "R11": (3.25, 14.75, 90), "D5": (11.5, 7.0, 180),
    "R16": (20.5, 2.0, 0), "D8": (20.5, 6.5, 0),
...
def measurements(board):
    ...
    links = {
        ...
        "usb_vbus_to_input_cap": (("J2", "1"), ("C6", "1")),
        "usb_ground_to_input_cap": (("J2", "2"), ("C6", "2")),
